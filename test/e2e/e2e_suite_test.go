...
var (
	...
	projectImage = "example.com/custom-controller-kubebuilder:v0.0.1"
)
...
func TestE2E(t *testing.T) {
	...
	_, _ = fmt.Fprintf(GinkgoWriter, "Starting custom-controller-kubebuilder integration test suite\n")
